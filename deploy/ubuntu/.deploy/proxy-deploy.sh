...
index() {
    ...
    echo "        <a href="http://pacificrack.sang.pp.ua/">index</a></br></br>"      >> /var/www/html/index.html
    echo "        <a href="http://pacificrack.sang.pp.ua/share">h5ai</a></br></br>"  >> /var/www/html/index.html
    echo "        <a href="http://pacificrack.sang.pp.ua:8888/">aria2</a></br></br>" >> /var/www/html/index.html
